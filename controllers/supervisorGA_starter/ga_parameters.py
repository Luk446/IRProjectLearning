NUM_GENERATIONS = 30  # Total number of generations to run
POPULATION_SIZE = 15  # Total number of individuals in the population
NUM_ELITE = 2  # Number of elite individuals to carry over to the next generation
TOURNAMENT_K = 3  # Number of individuals in tournament selection

CROSSOVER_RATE = 50  # Probability of crossover in percentage
MUTATION_RATE = 20  # Probability of mutation in percentage
